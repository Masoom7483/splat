...
f340.GetFinalCN = function (e, r, n, t, u, a, i, c, o, s, l) {
...
function m(e, r, n, t) {
  return e === f339.OuterCode.None && r === f339.LDPCFrameLength.L64800
    ? w(f341.cnLongLdpcOnly, n, t)
    : e === f339.OuterCode.None && r === f339.LDPCFrameLength.L16200
    ? w(f341.cnShortLdpcOnly, n, t)
    : e === f339.OuterCode.BCH && r === f339.LDPCFrameLength.L64800
    ? w(f341.cnLongLdpcBch, n, t)
    : e === f339.OuterCode.BCH && r === f339.LDPCFrameLength.L16200
    ? w(f341.cnShortLdpcBch, n, t)
    : e === f339.OuterCode.CRC && r === f339.LDPCFrameLength.L64800
    ? w(f341.cnLongLdpcOnly, n, t)
    : e === f339.OuterCode.CRC && r === f339.LDPCFrameLength.L16200
    ? w(f341.cnShortLdpcOnly, n, t)
    : null;
}
...
function w(e, r, n) {
  ...
  var t = e.find(function (e) {
    return e.modulation == r && e.coderate == n;
  });
...
function I(e, r, n, t) {
  var u =
    (D(e, r, n) +
      p(n, t) * ((1 / DxDy(n)) * z(e)) +
      CommonContinualPilots(r, e) * (8 / 3) ** 2) /
    numberOfCarriers(e, r);
...
function numberOfCarriers(FFTSize, BandwidthOption) {
  if (null != f341.numberOfCarriers) {
    var n = f341.numberOfCarriers.filter(
      (object) =>
        object.fftSize === FFTSize && object.bandwidthOption === BandwidthOption
    )[0];
...
function D(e, r, n) {
  return (
    numberOfCarriers(e, r) * (1 - 1 / DxDy(n)) - CommonContinualPilots(r, e)
  );
}

// var bitRate = f340.GetNetBitrate_mbit_s(
//   8, // "SP12_2" // ScatteredPilotPattern
//   0, // SystemBandwidth
//   2, // FFTSize
//   0, // BandwidthOption
//   3, // Modulation
